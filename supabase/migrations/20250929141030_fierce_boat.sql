/*
  # Initial Database Schema for Student Information Management System
  ...
  1. New Tables
    ...
    - `faculty` - Faculty-specific information and employment details
    - `departments` - Academic departments
    - `courses` - Course catalog
    - `course_sections` - Specific course offerings per semester
...
CREATE TABLE IF NOT EXISTS public.students (
  ...
  program TEXT NOT NULL DEFAULT 'General Studies',
...
CREATE TABLE IF NOT EXISTS public.faculty (
  ...
  position TEXT NOT NULL DEFAULT 'Lecturer',
...
CREATE TABLE IF NOT EXISTS public.assignments (
  ...
  title TEXT NOT NULL,
  description TEXT,
  type TEXT NOT NULL DEFAULT 'homework', -- 'homework', 'quiz', 'exam', 'project'
...
CREATE TABLE IF NOT EXISTS public.announcements (
  ...
  target_audience TEXT NOT NULL DEFAULT 'all', -- 'all', 'students', 'faculty', 'specific_course'
...
CREATE INDEX IF NOT EXISTS idx_course_sections_faculty_id ON public.course_sections(faculty_id);
CREATE INDEX IF NOT EXISTS idx_announcements_target ON public.announcements(target_audience, target_id);